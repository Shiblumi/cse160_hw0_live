...
class Vector3 {
  ...
  static dot(other1, other2) {
    ...
    let p1 = other1.elements[0] * other2.elements[0];
    let p2 = other1.elements[1] * other2.elements[1];
    let p3 = other1.elements[2] * other2.elements[2];
    d = p1 + p2 + p3;
    // Don't delete the return statement.
    return d;
  }
  ...
  static cross(other1, other2) {
    ...
    var v3 = new Vector3(); // Modify this line to calculate cross product between other1 and other2.
